...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->    
    <link href="css/validate/bootstrap.min.css" rel="stylesheet">
    <!-- bootstrap theme -->
    <link href="css/validate/bootstrap-theme.css" rel="stylesheet">
    <!--external css-->
    <!-- font icon -->
    <link href="css/validate/elegant-icons-style.css" rel="stylesheet" />
    <link href="css/validate/font-awesome.min.css" rel="stylesheet" />
    <!-- Custom styles -->
    <link href="css/validate/style.css" rel="stylesheet">
    <link href="css/validate/style-responsive.css" rel="stylesheet" />
  ...
  <!-- container section end -->
    ...
    <!-- nice scroll -->
    <script src="js/validator/jquery.scrollTo.min.js"></script>
    <script src="js/validator/jquery.nicescroll.js" type="text/javascript"></script>
    <!-- jquery validate js -->
