                        ...
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12" >
                            <div class="tile-stats">
                                ...
                                <div class="count">0</div>
                                     <h3>Students</h3>
                                <a href="registration.jsp">More Info</a>
                             </div>
                         </div>
                         <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12" >
                            <div class="tile-stats">
                                <div class="icon"><i class="fa fa-book"></i>k
                                </div>
                                <div class="count"><%out.print(new CourseController().viewCourse().size()); %></div>

                                <h3>Courses</h3>
                                <a href="course.jsp">More Info</a>
                            </div>
                        </div>
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <div class="count"><% out.print(new GroupController().viewGroups().size()); %></div>

                                <h3>Groups</h3>
                                <a href="groups.jsp">More Info</a>
                            </div>
                        </div>
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <div class="count"><%out.print(new FeesTemplateController().viewTemplates().size());%></div>

                                <h3>Fees Structure</h3>
                                <a href="fees-structure.jsp">More Info</a>
                            </div>
                        </div>
                                                <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <div class="count"><%out.print(new TemplateItemController().viewTemplateItem().size());%></div>

                                <h3>Fees Structure Item</h3>
                               <a href="templateitem.jsp">More Info</a>
                            </div>
                        </div>
                                                <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
